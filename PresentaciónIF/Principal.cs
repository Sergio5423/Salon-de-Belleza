...
namespace PresentaciónIF
{
    public partial class Principal : Form
    {
        ...
        public void Eliminar()
        {
            if (cbCategoria.SelectedIndex == 0)
            {
                gestionAlisados.Borrar(cbCategoria.Text);
            } else
            {
                if (cbCategoria.SelectedIndex == 1)
                {
                    gestionTrabajoColor.Borrar(cbCategoria.Text);
                } else
                {
                    if (cbCategoria.SelectedIndex == 2)
                    {
                        gestionMantenimiento.Borrar(cbCategoria.Text);
                    } else
                    {
                        if (cbCategoria.SelectedIndex == 3)
                        {
                            gestionIrregulares.Borrar(cbCategoria.Text);
                        } else
                        {
